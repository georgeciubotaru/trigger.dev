...
export const pullRequestReviewCommentCreated: EventSpecificationExample = {
  ...
  payload: {
    ...
    comment: {
      url: "https://github.com/triggerdotdev/empty/pull/5#pullrequestreview-1491475123",
      pull_request_review_id: 1491475123,
      id: 1310192629,
      diff_hunk: "",
      user: {
        id: 10635986,
